...
{
	//Update the turn left speed movement based on the frame time and whether the user is holding the key down or not
	if (keydown)
	{
...
{
	//Update the turn right speed movement based on the frame time and whether the user is holding the key down or not
	if (keydown)
	{
